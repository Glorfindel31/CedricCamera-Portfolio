  ...
  return show
    ? ReactDOM.createPortal(
        <div className={style.modal}>
          <div onClick={onClose} className={style['modal__backdrop']}></div>
          <div className={style['modal__popbox']}>
            <section>
              ...
              <p>
                ...
                grand destiny gently unfolded, a legacy whispered from a
                grandfather&apos;s delicate dance with macro and portrait imagery.
              </p>
              <p>
              ...
              <p>
                Step into Cedric&apos;s world, a realm where every frame is a sonnet,
                every shutter&apos;s whisper a delicate verse in the eternal dance of
                light and life. Welcome to the journey, a poetic pilgrimage bathed in
                radiant hues and timeless moments.
              </p>
              <p>
