      ...
      <div className={style.item} onClick={modalHandler}>
        <div className="relative">
          {isLoaded && (
            <div
              role="status"
              className="absolute inset-0 flex items-center justify-center space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center"
            >
              <div className="flex items-center justify-center w-full h-full bg-gray-400 sm:w-96 dark:bg-gray-800">
                <svg
